 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b=function(t,e){if(!t)throw zn(e)},zn=function(t){return new Error("Firebase Database ("+bu.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mu="[DEFAULT]",Kg={[jr]:"fire-core",[bg]:"fire-core-compat",[Ig]:"fire-analytics",[wg]:"fire-analytics-compat",[Tg]:"fire-app-check",[Sg]:"fire-app-check-compat",[Rg]:"fire-auth",[xg]:"fire-auth-compat",[Ng]:"fire-rtdb",[Ag]:"fire-rtdb-compat",[Pg]:"fire-fn",[Og]:"fire-fn-compat",[kg]:"fire-iid",[Mg]:"fire-iid-compat",[Dg]:"fire-fcm",[Lg]:"fire-fcm-compat",[Fg]:"fire-perf",[Bg]:"fire-perf-compat",[Hg]:"fire-rc",[Wg]:"fire-rc-compat",[Ug]:"fire-gcs",[$g]:"fire-gcs-compat",[jg]:"fire-fst",[Vg]:"fire-fst-compat","fire-js":"fire-js",[qg]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jg=zg;function Zg(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:Mu,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw ln.create("bad-app-name",{appName:String(s)});const i=li.get(s);if(i){if(Wr(t,i.options)&&Wr(n,i.config))return i;throw ln.create("duplicate-app",{appName:s})}const r=new ig(s);for(const l of Vr.values())r.addComponent(l);const o=new Xg(t,n,r);return li.set(s,o),o}function em(t=Mu){const e=li.get(t);if(!e)throw ln.create("no-app",{appName:t});return e}function xn(t,e,n){var s;let i=(s=Kg[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Do.warn(l.join(" "));return}ai(new Is(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cm(t){ai(new Is("platform-logger",e=>new Eg(e),"PRIVATE")),ai(new Is("heartbeat",e=>new om(e),"PRIVATE")),xn(jr,ba,t),xn(jr,ba,"esm2017"),xn("fire-js","")}cm("");var um="firebase",hm="9.9.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xn(um,hm,"app");const Ta="@firebase/database",Ra="0.13.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bo="5",$u="v",ju="s",Vu="r",qu="f",zu=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Ku="ls",Gu="p",Gr="ac",Yu="websocket",Qu="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zs;class ah extends Hi{static get __EMPTY_NODE(){return zs}static set __EMPTY_NODE(e){zs=e}compare(e,n){return dn(e.name,n.name)}isDefinedOn(e){throw zn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return q.MIN}maxPost(){return new q($t,zs)}makePost(e,n){return b(typeof e=="string","KeyIndex indexValue must always be a string."),new q(e,zs)}toString(){return".key"}}const on=new ah;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let hr;const vn={};class bt{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return b(vn&&ve,"ChildrenNode.ts has not been loaded"),hr=hr||new bt({".priority":vn},{".priority":ve}),hr}get(e){const n=Mn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Ue?n:null}hasIndex(e){return mt(this.indexSet_,e.toString())}addIndex(e,n){b(e!==on,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(q.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=hi(s,e.getCompare()):l=vn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const u=Object.assign({},this.indexes_);return u[a]=l,new bt(u,c)}addToIndexes(e,n){const s=oi(this.indexes_,(i,r)=>{const o=Mn(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),i===vn)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator(q.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),hi(l,o.getCompare())}else return vn;else{const l=n.get(e.name);let a=i;return l&&(a=a.remove(new q(e.name,l))),a.insert(e,e.node)}});return new bt(s,this.indexSet_)}removeFromIndexes(e,n){const s=oi(this.indexes_,i=>{if(i===vn)return i;{const r=n.get(e.name);return r?i.remove(new q(e.name,r)):i}});return new bt(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var it;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(it||(it={}));function Ko(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Go(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Yo(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(e,n){this.source=e,this.path=n,this.type=it.LISTEN_COMPLETE}operationForChild(e){return z(this.path)?new Os(this.source,ee()):new Os(this.source,pe(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=it.OVERWRITE}operationForChild(e){return z(this.path)?new un(this.source,ee(),this.snap.getImmediateChild(e)):new un(this.source,pe(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=it.MERGE}operationForChild(e){if(z(this.path)){const n=this.children.subtree(new se(e));return n.isEmpty()?null:n.value?new un(this.source,ee(),n.value):new Dn(this.source,ee(),n)}else return b(G(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Dn(this.source,pe(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dy{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Ly(t,e,n,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(wy(o.childName,o.snapshotNode))}),ss(t,i,"child_removed",e,s,n),ss(t,i,"child_added",e,s,n),ss(t,i,"child_moved",r,s,n),ss(t,i,"child_changed",e,s,n),ss(t,i,"value",e,s,n),i}function ss(t,e,n,s,i,r){const o=s.filter(l=>l.type===n);o.sort((l,a)=>By(t,l,a)),o.forEach(l=>{const a=Fy(t,l,r);i.forEach(c=>{c.respondsTo(l.type)&&e.push(c.createEvent(a,t.query_))})})}function Fy(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function By(t,e,n){if(e.childName==null||n.childName==null)throw zn("Should only compare child_ events.");const s=new q(e.childName,e.snapshotNode),i=new q(n.childName,n.snapshotNode);return t.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lt{constructor(e){this.writeTree_=e}static empty(){return new lt(new fe(null))}}function ps(t,e,n){if(z(e))return new lt(new fe(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=Le(i,e);return r=r.updateChild(o,n),new lt(t.writeTree_.set(i,r))}else{const i=new fe(n),r=t.writeTree_.setTree(e,i);return new lt(r)}}}function Xr(t,e,n){let s=t;return Me(n,(i,r)=>{s=ps(s,ye(e,i),r)}),s}function za(t,e){if(z(e))return lt.empty();{const n=t.writeTree_.setTree(e,new fe(null));return new lt(n)}}function Jr(t,e){return pn(t,e)!=null}function pn(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Le(n.path,e)):null}function Ka(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(ve,(s,i)=>{e.push(new q(s,i))}):t.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new q(s,i.value))}),e}function Bt(t,e){if(z(e))return t;{const n=pn(t,e);return n!=null?new lt(new fe(n)):new lt(t.writeTree_.subtree(e))}}function Zr(t){return t.writeTree_.isEmpty()}function Ln(t,e){return gh(ee(),t.writeTree_,e)}function gh(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(b(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):n=gh(ye(t,i),r,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(ye(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ui(t,e){return Eh(e,t)}function Wy(t,e,n,s,i){b(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=ps(t.visibleWrites,e,n)),t.lastWriteId=s}function Uy(t,e,n,s){b(s>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:s,visible:!0}),t.visibleWrites=Xr(t.visibleWrites,e,n),t.lastWriteId=s}function $y(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function jy(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);b(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&Vy(l,s.path)?i=!1:Xe(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return qy(t),!0;if(s.snap)t.visibleWrites=za(t.visibleWrites,s.path);else{const l=s.children;Me(l,a=>{t.visibleWrites=za(t.visibleWrites,ye(s.path,a))})}return!0}else return!1}function Vy(t,e){if(t.snap)return Xe(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Xe(ye(t.path,n),e))return!0;return!1}function qy(t){t.visibleWrites=mh(t.allWrites,zy,ee()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function zy(t){return t.visible}function mh(t,e,n){let s=lt.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let l;if(r.snap)Xe(n,o)?(l=Le(n,o),s=ps(s,l,r.snap)):Xe(o,n)&&(l=Le(o,n),s=ps(s,ee(),r.snap.getChild(l)));else if(r.children){if(Xe(n,o))l=Le(n,o),s=Xr(s,l,r.children);else if(Xe(o,n))if(l=Le(o,n),z(l))s=Xr(s,ee(),r.children);else{const a=Mn(r.children,G(l));if(a){const c=a.getChild(pe(l));s=ps(s,ee(),c)}}}else throw zn("WriteRecord should have .snap or .children")}}return s}function yh(t,e,n,s,i){if(!s&&!i){const r=pn(t.visibleWrites,e);if(r!=null)return r;{const o=Bt(t.visibleWrites,e);if(Zr(o))return n;if(n==null&&!Jr(o,ee()))return null;{const l=n||B.EMPTY_NODE;return Ln(o,l)}}}else{const r=Bt(t.visibleWrites,e);if(!i&&Zr(r))return n;if(!i&&n==null&&!Jr(r,ee()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(Xe(c.path,e)||Xe(e,c.path))},l=mh(t.allWrites,o,e),a=n||B.EMPTY_NODE;return Ln(l,a)}}}function Ky(t,e,n){let s=B.EMPTY_NODE;const i=pn(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(ve,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=Bt(t.visibleWrites,e);return n.forEachChild(ve,(o,l)=>{const a=Ln(Bt(r,new se(o)),l);s=s.updateImmediateChild(o,a)}),Ka(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Bt(t.visibleWrites,e);return Ka(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function Gy(t,e,n,s,i){b(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=ye(e,n);if(Jr(t.visibleWrites,r))return null;{const o=Bt(t.visibleWrites,r);return Zr(o)?i.getChild(n):Ln(o,i.getChild(n))}}function Yy(t,e,n,s){const i=ye(e,n),r=pn(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=Bt(t.visibleWrites,i);return Ln(o,s.getNode().getImmediateChild(n))}else return null}function Qy(t,e){return pn(t.visibleWrites,e)}function Xy(t,e,n,s,i,r,o){let l;const a=Bt(t.visibleWrites,e),c=pn(a,ee());if(c!=null)l=c;else if(n!=null)l=Ln(a,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),f=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let _=f.getNext();for(;_&&u.length<i;)h(_,s)!==0&&u.push(_),_=f.getNext();return u}else return[]}function Jy(){return{visibleWrites:lt.empty(),allWrites:[],lastWriteId:-1}}function gi(t,e,n,s){return yh(t.writeTree,t.treePath,e,n,s)}function Qo(t,e){return Ky(t.writeTree,t.treePath,e)}function Ga(t,e,n,s){return Gy(t.writeTree,t.treePath,e,n,s)}function mi(t,e){return Qy(t.writeTree,ye(t.treePath,e))}function Zy(t,e,n,s,i,r){return Xy(t.writeTree,t.treePath,e,n,s,i,r)}function Xo(t,e,n){return Yy(t.writeTree,t.treePath,e,n)}function vh(t,e){return Eh(ye(t.treePath,e),t.writeTree)}function Eh(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nv(t){return{filter:t}}function sv(t,e){b(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),b(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function iv(t,e,n,s,i){const r=new ev;let o,l;if(n.type===it.OVERWRITE){const c=n;c.source.fromUser?o=eo(t,e,c.path,c.snap,s,i,r):(b(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered()&&!z(c.path),o=yi(t,e,c.path,c.snap,s,i,l,r))}else if(n.type===it.MERGE){const c=n;c.source.fromUser?o=ov(t,e,c.path,c.children,s,i,r):(b(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered(),o=to(t,e,c.path,c.children,s,i,l,r))}else if(n.type===it.ACK_USER_WRITE){const c=n;c.revert?o=cv(t,e,c.path,s,i,r):o=lv(t,e,c.path,c.affectedTree,s,i,r)}else if(n.type===it.LISTEN_COMPLETE)o=av(t,e,n.path,s,r);else throw zn("Unknown operation type: "+n.type);const a=r.getChanges();return rv(e,o,a),{viewCache:o,changes:a}}function rv(t,e,n){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=_i(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&n.push(by(_i(e)))}}function bh(t,e,n,s,i,r){const o=e.eventCache;if(mi(s,n)!=null)return e;{let l,a;if(z(n))if(b(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=hn(e),u=c instanceof B?c:B.EMPTY_NODE,h=Qo(s,u);l=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=gi(s,hn(e));l=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=G(n);if(c===".priority"){b(jt(n)===1,"Can't have a priority with additional path components");const u=o.getNode();a=e.serverCache.getNode();const h=Ga(s,n,u,a);h!=null?l=t.filter.updatePriority(u,h):l=o.getNode()}else{const u=pe(n);let h;if(o.isCompleteForChild(c)){a=e.serverCache.getNode();const f=Ga(s,n,o.getNode(),a);f!=null?h=o.getNode().getImmediateChild(c).updateChild(u,f):h=o.getNode().getImmediateChild(c)}else h=Xo(s,c,e.serverCache);h!=null?l=t.filter.updateChild(o.getNode(),c,h,u,i,r):l=o.getNode()}}return ds(e,l,o.isFullyInitialized()||z(n),t.filter.filtersNodes())}}function yi(t,e,n,s,i,r,o,l){const a=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(z(n))c=u.updateFullNode(a.getNode(),s,null);else if(u.filtersNodes()&&!a.isFiltered()){const _=a.getNode().updateChild(n,s);c=u.updateFullNode(a.getNode(),_,null)}else{const _=G(n);if(!a.isCompleteForPath(n)&&jt(n)>1)return e;const m=pe(n),T=a.getNode().getImmediateChild(_).updateChild(m,s);_===".priority"?c=u.updatePriority(a.getNode(),T):c=u.updateChild(a.getNode(),_,T,m,Ch,null)}const h=_h(e,c,a.isFullyInitialized()||z(n),u.filtersNodes()),f=new Jo(i,h,r);return bh(t,h,n,i,f,l)}function eo(t,e,n,s,i,r,o){const l=e.eventCache;let a,c;const u=new Jo(i,e,r);if(z(n))c=t.filter.updateFullNode(e.eventCache.getNode(),s,o),a=ds(e,c,!0,t.filter.filtersNodes());else{const h=G(n);if(h===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),s),a=ds(e,c,l.isFullyInitialized(),l.isFiltered());else{const f=pe(n),_=l.getNode().getImmediateChild(h);let m;if(z(f))m=s;else{const S=u.getCompleteChild(h);S!=null?Uo(f)===".priority"&&S.getChild(rh(f)).isEmpty()?m=S:m=S.updateChild(f,s):m=B.EMPTY_NODE}if(_.equals(m))a=e;else{const S=t.filter.updateChild(l.getNode(),h,m,f,u,o);a=ds(e,S,l.isFullyInitialized(),t.filter.filtersNodes())}}}return a}function Ya(t,e){return t.eventCache.isCompleteForChild(e)}function ov(t,e,n,s,i,r,o){let l=e;return s.foreach((a,c)=>{const u=ye(n,a);Ya(e,G(u))&&(l=eo(t,l,u,c,i,r,o))}),s.foreach((a,c)=>{const u=ye(n,a);Ya(e,G(u))||(l=eo(t,l,u,c,i,r,o))}),l}function Qa(t,e,n){return n.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function to(t,e,n,s,i,r,o,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,c;z(n)?c=s:c=new fe(null).setTree(n,s);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,f)=>{if(u.hasChild(h)){const _=e.serverCache.getNode().getImmediateChild(h),m=Qa(t,_,f);a=yi(t,a,new se(h),m,i,r,o,l)}}),c.children.inorderTraversal((h,f)=>{const _=!e.serverCache.isCompleteForChild(h)&&f.value===void 0;if(!u.hasChild(h)&&!_){const m=e.serverCache.getNode().getImmediateChild(h),S=Qa(t,m,f);a=yi(t,a,new se(h),S,i,r,o,l)}}),a}function lv(t,e,n,s,i,r,o){if(mi(i,n)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(s.value!=null){if(z(n)&&a.isFullyInitialized()||a.isCompleteForPath(n))return yi(t,e,n,a.getNode().getChild(n),i,r,l,o);if(z(n)){let c=new fe(null);return a.getNode().forEachChild(on,(u,h)=>{c=c.set(new se(u),h)}),to(t,e,n,c,i,r,l,o)}else return e}else{let c=new fe(null);return s.foreach((u,h)=>{const f=ye(n,u);a.isCompleteForPath(f)&&(c=c.set(u,a.getNode().getChild(f)))}),to(t,e,n,c,i,r,l,o)}}function av(t,e,n,s,i){const r=e.serverCache,o=_h(e,r.getNode(),r.isFullyInitialized()||z(n),r.isFiltered());return bh(t,o,n,s,Ch,i)}function cv(t,e,n,s,i,r){let o;if(mi(s,n)!=null)return e;{const l=new Jo(s,e,i),a=e.eventCache.getNode();let c;if(z(n)||G(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=gi(s,hn(e));else{const h=e.serverCache.getNode();b(h instanceof B,"serverChildren would be complete if leaf node"),u=Qo(s,h)}u=u,c=t.filter.updateFullNode(a,u,r)}else{const u=G(n);let h=Xo(s,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?c=t.filter.updateChild(a,u,h,pe(n),l,r):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(a,u,B.EMPTY_NODE,pe(n),l,r):c=a,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=gi(s,hn(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||mi(s,ee())!=null,ds(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qn{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return z(this._path)?null:Uo(this._path)}get ref(){return new qt(this._repo,this._path)}get _queryIdentifier(){const e=Va(this._queryParams),n=Fo(e);return n==="{}"?"default":n}get _queryObject(){return Va(this._queryParams)}isEqual(e){if(e=fn(e),!(e instanceof Qn))return!1;const n=this._repo===e._repo,s=oh(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+ty(this._path)}}function pE(t,e){if(t._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function yl(t){let e=null,n=null;if(t.hasStart()&&(e=t.getIndexStartValue()),t.hasEnd()&&(n=t.getIndexEndValue()),t.getIndex()===on){const s="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(t.hasStart()){if(t.getIndexStartName()!==cn)throw new Error(s);if(typeof e!="string")throw new Error(i)}if(t.hasEnd()){if(t.getIndexEndName()!==$t)throw new Error(s);if(typeof n!="string")throw new Error(i)}}else if(t.getIndex()===ve){if(e!=null&&!so(e)||n!=null&&!so(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(b(t.getIndex()instanceof Vo||t.getIndex()===dh,"unknown index type."),e!=null&&typeof e=="object"||n!=null&&typeof n=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function $h(t){if(t.hasStart()&&t.hasEnd()&&t.hasLimit()&&!t.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class qt extends Qn{constructor(e,n){super(e,n,new zo,!1)}get parent(){const e=rh(this._path);return e===null?null:new qt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ci{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new se(e),s=Wn(this.ref,e);return new Ci(this._node.getChild(n),s,ve)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Ci(i,Wn(this.ref,s),ve)))}hasChild(e){const n=new se(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function _E(t,e){return t=fn(t),t._checkNotDeleted("ref"),e!==void 0?Wn(t._root,e):t._root}function Wn(t,e){return t=fn(t),G(t._path)===null?Gv("child","path",e,!1):hl("child","path",e,!1),new qt(t._repo,ye(t._path,e))}function gE(t,e){t=fn(t),fl("push",t._path),Ws("push",e,t._path,!0);const n=Fh(t._repo),s=Cy(n),i=Wn(t,s),r=Wn(t,s);let o;return e!=null?o=jh(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function mE(t){return fl("remove",t._path),jh(t,null)}function jh(t,e){t=fn(t),fl("set",t._path),Ws("set",e,t._path,!1);const n=new ks;return rE(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function yE(t,e){zv("update",e,t._path,!1);const n=new ks;return oE(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function vE(t){return t=fn(t),iE(t._repo,t).then(e=>new Ci(e,new qt(t._repo,t._path),t._queryParams.getIndex()))}class Gi{}class EE extends Gi{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){Ws("endAt",this._value,e._path,!0);const n=Ry(e._queryParams,this._value,this._key);if($h(n),yl(n),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new Qn(e._repo,e._path,n,e._orderByCalled)}}class CE extends Gi{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){Ws("startAt",this._value,e._path,!0);const n=Ty(e._queryParams,this._value,this._key);if($h(n),yl(n),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new Qn(e._repo,e._path,n,e._orderByCalled)}}class bE extends Gi{constructor(e){super(),this._path=e}_apply(e){pE(e,"orderByChild");const n=new se(this._path);if(z(n))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const s=new Vo(n),i=xy(e._queryParams,s);return yl(i),new Qn(e._repo,e._path,i,!0)}}function wE(t){if(t==="$key")throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if(t==="$priority")throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if(t==="$value")throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return hl("orderByChild","path",t,!1),new bE(t)}class IE extends Gi{constructor(e,n){super(),this._value=e,this._key=n}_apply(e){if(Ws("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new EE(this._value,this._key)._apply(new CE(this._value,this._key)._apply(e))}}function SE(t,e){return Kv("equalTo","key",e,!0),new IE(t,e)}function TE(t,...e){let n=fn(t);for(const s of e)n=s._apply(n);return n}_v(qt);Cv(qt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ME(t){fm(Jg),ai(new Is("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return NE(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),xn(Ta,Ra,t),xn(Ta,Ra,"esm2017")}It.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};It.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};ME();const DE={apiKey:"AIzaSyC5RpSCtGtGiZwcy4RDbSMrSTelXFr4oO8",authDomain:"short-links-78fa0.firebaseapp.com",projectId:"short-links-78fa0",storageBucket:"short-links-78fa0.appspot.com",messagingSenderId:"301674154227",appId:"1:301674154227:web:3350cef1d31a7df96f8f86"},LE=Zg(DE),oo=kE(LE),lo=_E,FE=gE,BE=Wn,uC=TE,HE=yE,WE=mE,hC=wE,fC=SE,dC=vE,UE=["onSubmit"],$E=_t("button",{type:"submit",class:"p-1 px-5 text-xl rounded-xl text-white bg-indigo-800 h-12 hover:bg-indigo-700 active:bg-indigo-900"}," \u0421\u0433\u0435\u043D\u0435\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C ",-1),jE={key:0,class:"error text-xl bg-red-200 rounded-xl mt-4 py-2 px-5"},VE=qn({__name:"FormItem",setup(t){const e=Fi(),n=ys(""),s=ys(""),i=Ze("emitter");Rn(()=>n.value,(a,c)=>{a.length&&!l(a)?s.value="\u0422\u0435\u043A\u0441\u0442 \u043D\u0435 \u044F\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0441\u0441\u044B\u043B\u043A\u043E\u0439":s.value=""});const r=async()=>{if(!l(n.value)){s.value="\u0422\u0435\u043A\u0441\u0442 \u043D\u0435 \u044F\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0441\u0441\u044B\u043B\u043A\u043E\u0439";return}e.isLoading=!0;const a=FE(BE(lo(oo),"links")).key,c=o(a),u={},h={original_link:n.value,timestamp:Date.now(),short_link:document.location.origin+"/vue-link-shortener/"+c,short_code:c,code:a};u["/links/"+a]=h,HE(lo(oo),u).then(()=>{n.value="",e.setLinks(h),i.emit("sendData"),e.isLoading=!1}).catch(f=>{s.value="\u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445 "+f,e.isLoading=!1})},o=a=>H_(a,5)(),l=a=>a.match(/(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g)!==null;return(a,c)=>(wt(),nn(qe,null,[_t("form",{action:"#",class:"p-5 mx-auto w-full bg-white flex items-center gap-3 rounded-xl shadow border-2 bg-blue-400",onSubmit:Mr(r,["prevent"])},[dd(_t("input",{type:"text",class:"w-full text-xl text-gray-800 p-1 px-4 rounded-xl h-12",placeholder:"https://www.google.com/search?q=smile","onUpdate:modelValue":c[0]||(c[0]=u=>n.value=u)},null,512),[[gp,n.value]]),$E],40,UE),s.value?(wt(),nn("div",jE,Gs(s.value),1)):su("",!0)],64))}}),qE={key:0,class:"loading absolute left-2/4 top-5 -mx-12 block w-24 h-24 rounded-full border-8 border-indigo-800"},zE=qn({__name:"LoadingRound",setup(t){const e=Fi();return(n,s)=>Dt(e).isLoading?(wt(),nn("span",qE)):su("",!0)}});const vl=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},KE=vl(zE,[["__scopeId","data-v-87a85753"]]),GE={class:"list-links relative"},YE={class:"m-0 mt-5 p-0 list-none flex flex-col gap-2"},QE={class:"overflow-hidden whitespace-nowrap text-ellipsis h-6"},XE={class:"ml-auto whitespace-nowrap"},JE=["onClick"],ZE=["onClick"],eC=qn({__name:"LinksItem",setup(t){const e=Fi(),n=We(()=>{function o(l,a){return l.timestamp>a.timestamp?-1:l.name<a.name?1:0}return e.getLinks.sort(o)}),s=Ze("emitter"),i=o=>{navigator.clipboard.writeText(o==null?void 0:o.short_link),e.setLableCopy(o),setTimeout(()=>{e.setLableCopy()},5e3)},r=o=>{e.isLoading=!0,WE(lo(oo,"links/"+o.code)).then(async()=>{e.deleteLink(o),await e.getLinks,e.isLoading=!1}).catch(l=>{alert("\u041E\u0448\u0438\u0431\u043A\u0430 "+l),e.isLoading=!1})};return s.on("sendData",async()=>{await e.getLinks}),(o,l)=>(wt(),nn("div",GE,[_t("ul",YE,[(wt(!0),nn(qe,null,md(Dt(n),a=>(wt(),nn("li",{key:a==null?void 0:a.short_code,class:"flex items-center justify-between gap-4 bg-blue-200 rounded-lg px-4 py-3"},[_t("span",QE,Gs(a==null?void 0:a.original_link),1),_t("span",XE,Gs(a==null?void 0:a.short_link),1),_t("button",{onClick:Mr(c=>i(a),["prevent"]),class:bi(["copy w-24 px-3 py-1 text-white rounded-lg cursor-pointer select-none",{"bg-purple-700":(a==null?void 0:a.copied)===!0,"bg-blue-500 hover:bg-blue-400 active:bg-blue-600":!(a!=null&&a.copied)}])},Gs(a!=null&&a.copied?"Copied":"Copy"),11,JE),_t("button",{onClick:Mr(c=>r(a),["prevent"]),class:"text-lg px-2 py-0 text-white rounded-lg cursor-pointer bg-red-500 hover:bg-red-400 active:bg-red-600 select-none"}," \xD7 ",8,ZE)]))),128))]),Oe(KE)]))}});const tC=vl(eC,[["__scopeId","data-v-97086777"]]),nC=qn({__name:"HomeView",setup(t){return(e,n)=>(wt(),nn(qe,null,[Oe(VE),Oe(tC)],64))}}),sC=[{path:"/",name:"home",component:nC},{path:"/:slug",name:"redirectLink",component:()=>Op(()=>import("./RedirectView.b19da375.js"),[])}],Vh=D_({history:Qp("/vue-link-shortener/"),routes:sC});Vh.beforeEach(()=>{const t=Fi();t.isLoading=!1});const iC={};function rC(t,e){const n=pd("router-view");return wt(),tu(n)}const oC=vl(iC,[["render",rC]]);function lC(t){return{all:t=t||new Map,on:function(e,n){var s=t.get(e);s?s.push(n):t.set(e,[n])},off:function(e,n){var s=t.get(e);s&&(n?s.splice(s.indexOf(n)>>>0,1):t.set(e,[]))},emit:function(e,n){var s=t.get(e);s&&s.slice().map(function(i){i(n)}),(s=t.get("*"))&&s.slice().map(function(i){i(e,n)})}}}const aC=lC(),Yi=Cp(oC);Yi.use(Vh);Yi.use(Ip());Yi.provide("emitter",aC);Yi.mount("#app");export{KE as L,nn as a,tu as b,We as c,qn as d,su as e,Oe as f,Bd as g,_t as h,lo as i,fC as j,dC as k,pd as l,wt as m,cC as n,hC as o,oo as p,uC as q,ys as r,Fi as u,zf as w};
